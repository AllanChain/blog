/**
 * Code copied from https://github.com/jGleitz/markdown-it-prism/blob/v2.0.5/index.js
 * Modified to add features like:
 * - default language none
 * - enhance node side render
 */
...
function highlight (markdownit, options, text, lang) {
  ...
  const classAttribute = langToUse
    ...
    : ` class="${markdownit.options.langPrefix}none"`
